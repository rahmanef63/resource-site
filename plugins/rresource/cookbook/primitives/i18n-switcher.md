# Primitive — i18n-switcher

> **Tier:** M
> **Lifted from:** kitab cms-public-storefront LanguageProvider — generalize to N locales

## Tujuan

Language toggle + per-route locale resolution. Server-component-friendly. localStorage + cookie persist.
...
```
(none — pure React Context + cookies)
```
...
const t = useT();
<LanguageSwitcher locales={["id","en","ja"]} />
<h1>{t("hero.title")}</h1>
```
