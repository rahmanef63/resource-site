# Primitive — feedback-widget

> **Tier:** M
> **Lifted from:** CareerPack/convex/feedback/* + slices/admin-panel/components/FeedbackInbox.tsx + shared/components/FeedbackButton.tsx

## Tujuan

Floating feedback button + form + Convex inbox + admin viewer.
...
<FeedbackButton />   // floats bottom-right
```
