...
> **Tier:** M
> **Lifted from:** CareerPack/convex/admin/auditLog.ts + slices/admin-panel/components/AuditLogView.tsx

## Tujuan

User-action audit trail. Append-only Convex table + admin viewer w/ filter.
...
await logAudit(ctx, { action: "user.delete", targetId, meta: { reason } });
```
