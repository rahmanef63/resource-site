# Primitive — pdf-generator

> **Tier:** M
> **Lifted from:** CareerPack/frontend/src/slices/cv-generator/lib/pdf.ts + DownloadPdfButton.tsx

## Tujuan

Convert any DOM subtree to printable PDF client-side. No server roundtrip. ATS-safe text-selectable PDF, not raster.
...
```tsx
import { generatePdfFromElement } from "@/shared/lib/pdf";
const ref = useRef<HTMLDivElement>(null);
<button onClick={() => generatePdfFromElement(ref.current, { filename: "doc.pdf" })}>Download</button>
```
