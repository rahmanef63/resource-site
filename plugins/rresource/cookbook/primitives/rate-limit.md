# Primitive — rate-limit

> **Tier:** S
> **Lifted from:** CareerPack/convex/_shared/rateLimit.ts + rateLimit table fragment
...
export const myAction = action({
  args: {},
  handler: async (ctx) => {
    await requireQuota(ctx);   // throws "Quota terlampaui" if exceeded
    // … real work
  },
});
```
