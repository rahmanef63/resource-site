---
description: Full-width image carousel hero w/ auto-fade + dot indicators. Trigger when user runs /rresource:hero-carousel or asks to scaffold "hero-carousel" template into the current project.
---

# rresource:hero-carousel

**Kind:** layout
**Bundled spec:** `cookbook/layouts/hero-carousel.md`
...
2. **Read bundled spec.** Open `cookbook/layouts/hero-carousel.md` (relative to plugin
