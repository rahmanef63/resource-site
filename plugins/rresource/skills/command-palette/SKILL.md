---
description: cmdk-based ⌘K palette w/ fuzzy search + recent + grouped commands. Trigger when user runs /rresource:command-palette or asks to scaffold "command-palette" template into the current project.
---

# rresource:command-palette

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/command-palette.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/command-palette.md` (relative to plugin
