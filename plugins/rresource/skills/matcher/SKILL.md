---
description: Job + skill matcher (L). Slice + 2-table Convex domain + AI actions (ATS scoring, cover-letter, CV-tailoring) + external feed pipelines. Trigger when user runs /rresource:matcher or asks to scaffold "matcher" template into the current project.
---

# rresource:matcher

**Kind:** feature
**Bundled spec:** `cookbook/features/matcher.md`
...
2. **Read bundled spec.** Open `cookbook/features/matcher.md` (relative to plugin
