---
description: Feature-grid marketing landing — Card + Magnetic + KineticHeading. Modern SaaS feel. Trigger when user runs /rresource:bento or asks to scaffold "bento" template into the current project.
---

# rresource:bento

**Kind:** layout
**Bundled spec:** `cookbook/layouts/bento.md`
...
2. **Read bundled spec.** Open `cookbook/layouts/bento.md` (relative to plugin
