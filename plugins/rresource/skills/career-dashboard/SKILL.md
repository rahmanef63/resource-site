---
description: Job-application tracker — Table + Kanban + stats (L). Slice + shared useApplications hook + shared DataTable + Convex module + schema table + manifest/binder wiring. Trigger when user runs /rresource:career-dashboard or asks to scaffold "career-dashboard" template into the current project.
---

# rresource:career-dashboard
...
2. **Read bundled spec.** Open `cookbook/features/career-dashboard.md` (relative to plugin
