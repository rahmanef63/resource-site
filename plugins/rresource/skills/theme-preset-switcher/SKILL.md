---
description: OKLCH theme preset switcher w/ live preview + persist. Trigger when user runs /rresource:theme-preset-switcher or asks to scaffold "theme-preset-switcher" template into the current project.
---

# rresource:theme-preset-switcher

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/theme-preset-switcher.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/theme-preset-switcher.md` (relative to plugin
