---
description: Per-user table hub (M). Adds /dashboard/database. Trigger when user runs /rresource:database or asks to scaffold "database" template into the current project.
---

# rresource:database

**Kind:** feature
**Bundled spec:** `cookbook/features/database.md`
...
2. **Read bundled spec.** Open `cookbook/features/database.md` (relative to plugin
