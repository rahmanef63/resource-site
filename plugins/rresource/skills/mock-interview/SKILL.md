---
description: AI interview sim + answer eval + scoring (L). Slice + Convex module + schema table + AI actions + curated Indonesian question bank fallback. Trigger when user runs /rresource:mock-interview or asks to scaffold "mock-interview" template into the current project.
---

# rresource:mock-interview

**Kind:** feature
**Bundled spec:** `cookbook/features/mock-interview.md`
...
2. **Read bundled spec.** Open `cookbook/features/mock-interview.md` (relative to plugin
