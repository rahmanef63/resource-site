---
description: 11 database views (table, board, gallery, calendar, list, timeline, etc.). Trigger when user runs /rresource:database-views or asks to scaffold "database-views" template into the current project.
---

# rresource:database-views

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/database-views.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/database-views.md` (relative to plugin
