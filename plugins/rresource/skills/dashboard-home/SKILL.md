---
description: Dashboard overview tiles + recent activity (M). Adds /dashboard. Trigger when user runs /rresource:dashboard-home or asks to scaffold "dashboard-home" template into the current project.
---

# rresource:dashboard-home

**Kind:** feature
**Bundled spec:** `cookbook/features/dashboard-home.md`
...
2. **Read bundled spec.** Open `cookbook/features/dashboard-home.md` (relative to plugin
