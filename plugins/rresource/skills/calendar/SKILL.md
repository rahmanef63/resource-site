---
description: Career calendar w/ react-day-picker + date-fns (M). Adds /dashboard/calendar. Trigger when user runs /rresource:calendar or asks to scaffold "calendar" template into the current project.
---

# rresource:calendar

**Kind:** feature
**Bundled spec:** `cookbook/features/calendar.md`
...
2. **Read bundled spec.** Open `cookbook/features/calendar.md` (relative to plugin
