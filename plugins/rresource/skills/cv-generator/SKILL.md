---
description: CV editor + templates + PDF export + AI hints (L). Slice + 4+ shared deps + 1 Convex module + schema table + manifest/binder wiring + external PDF libs. Trigger when user runs /rresource:cv-generator or asks to scaffold "cv-generator" template into the current project.
---

# rresource:cv-generator

**Kind:** feature
**Bundled spec:** `cookbook/features/cv-generator.md`
...
2. **Read bundled spec.** Open `cookbook/features/cv-generator.md` (relative to plugin
