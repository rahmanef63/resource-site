---
description: India/intl document-prep tracker + curated templates (L). Slice + Convex module + schema + big Indonesian template seed + manifest/binder wiring. Trigger when user runs /rresource:document-checklist or asks to scaffold "document-checklist" template into the current project.
---

# rresource:document-checklist

**Kind:** feature
**Bundled spec:** `cookbook/features/document-checklist.md`
...
2. **Read bundled spec.** Open `cookbook/features/document-checklist.md` (relative to plugin
