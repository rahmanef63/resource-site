---
description: Multi-block selection across editor (shift-click + drag-rect). Trigger when user runs /rresource:multi-block-selection or asks to scaffold "multi-block-selection" template into the current project.
---

# rresource:multi-block-selection

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/multi-block-selection.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/multi-block-selection.md` (relative to plugin
