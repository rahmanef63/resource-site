---
description: Activity bar + tabs + editor + bottom panel. Editor-first apps. Trigger when user runs /rresource:ide or asks to scaffold "ide" template into the current project.
---

# rresource:ide

**Kind:** layout
**Bundled spec:** `cookbook/layouts/ide.md`
...
2. **Read bundled spec.** Open `cookbook/layouts/ide.md` (relative to plugin
