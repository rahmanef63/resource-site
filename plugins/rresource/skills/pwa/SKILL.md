---
description: PWA shell — sw.js + offline + install prompt + theme-color sync + bottom-nav (L infra). Trigger when user runs /rresource:pwa or asks to scaffold "pwa" template into the current project.
---

# rresource:pwa

**Kind:** feature
**Bundled spec:** `cookbook/features/pwa.md`
...
2. **Read bundled spec.** Open `cookbook/features/pwa.md` (relative to plugin
