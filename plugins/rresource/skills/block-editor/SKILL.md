---
description: Notion-style block editor w/ slash menu, drag-handles, multi-block selection. Trigger when user runs /rresource:block-editor or asks to scaffold "block-editor" template into the current project.
---

# rresource:block-editor

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/block-editor.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/block-editor.md` (relative to plugin
