---
description: Project showcase — multi-media + multi-link portfolio (L). Slice + FileUpload stack + 1 Convex domain + multi-media schema. Trigger when user runs /rresource:portfolio or asks to scaffold "portfolio" template into the current project.
---

# rresource:portfolio

**Kind:** feature
**Bundled spec:** `cookbook/features/portfolio.md`
...
2. **Read bundled spec.** Open `cookbook/features/portfolio.md` (relative to plugin
