---
description: Multi-section user settings (L). Adds /dashboard/settings. Trigger when user runs /rresource:settings or asks to scaffold "settings" template into the current project.
---

# rresource:settings

**Kind:** feature
**Bundled spec:** `cookbook/features/settings.md`
...
2. **Read bundled spec.** Open `cookbook/features/settings.md` (relative to plugin
