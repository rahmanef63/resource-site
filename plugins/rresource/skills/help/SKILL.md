---
description: Help center w/ search + FAQ (S). Adds /dashboard/help. Trigger when user runs /rresource:help or asks to scaffold "help" template into the current project.
---

# rresource:help

**Kind:** feature
**Bundled spec:** `cookbook/features/help.md`
...
2. **Read bundled spec.** Open `cookbook/features/help.md` (relative to plugin
