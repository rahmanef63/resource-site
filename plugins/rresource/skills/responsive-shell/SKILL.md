---
description: Mobile/Desktop containers + 14 responsive-* shadcn wrappers + nav SSOT + DASHBOARD_VIEWS registry (XL infra). Trigger when user runs /rresource:responsive-shell or asks to scaffold "responsive-shell" template into the current project.
---

# rresource:responsive-shell

**Kind:** feature
**Bundled spec:** `cookbook/features/responsive-shell.md`
...
2. **Read bundled spec.** Open `cookbook/features/responsive-shell.md` (relative to plugin
