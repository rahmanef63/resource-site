---
description: Brand-forward landing — letter-stagger headings + magnetic CTAs + marquee strips. Trigger when user runs /rresource:kinetic-text or asks to scaffold "kinetic-text" template into the current project.
---

# rresource:kinetic-text

**Kind:** layout
**Bundled spec:** `cookbook/layouts/kinetic-text.md`
...
2. **Read bundled spec.** Open `cookbook/layouts/kinetic-text.md` (relative to plugin
