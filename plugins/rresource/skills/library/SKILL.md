---
description: Content library (saved articles / templates) (M). Adds /dashboard/library. Trigger when user runs /rresource:library or asks to scaffold "library" template into the current project.
---

# rresource:library

**Kind:** feature
**Bundled spec:** `cookbook/features/library.md`
...
2. **Read bundled spec.** Open `cookbook/features/library.md` (relative to plugin
