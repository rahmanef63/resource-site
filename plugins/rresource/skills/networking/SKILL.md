---
description: Networking / contacts + outreach tracker (L). Slice + manifest + capability binder + 1 Convex domain + AI bus wiring. Trigger when user runs /rresource:networking or asks to scaffold "networking" template into the current project.
---

# rresource:networking

**Kind:** feature
**Bundled spec:** `cookbook/features/networking.md`
...
2. **Read bundled spec.** Open `cookbook/features/networking.md` (relative to plugin
