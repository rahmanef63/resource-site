---
description: Salary + tax comparator with recharts (L). Slice + 2-table Convex domain + recharts charts + heavy Indonesian locale data. Trigger when user runs /rresource:financial-calculator or asks to scaffold "financial-calculator" template into the current project.
---

# rresource:financial-calculator

**Kind:** feature
**Bundled spec:** `cookbook/features/financial-calculator.md`
...
2. **Read bundled spec.** Open `cookbook/features/financial-calculator.md` (relative to plugin
