---
description: Interactive skill tree + progress (L, large). Slice + Convex module (5 files) + 3 schema tables + curated Indonesian template seed. Trigger when user runs /rresource:skill-roadmap or asks to scaffold "skill-roadmap" template into the current project.
---

# rresource:skill-roadmap

**Kind:** feature
**Bundled spec:** `cookbook/features/skill-roadmap.md`
...
2. **Read bundled spec.** Open `cookbook/features/skill-roadmap.md` (relative to plugin
