---
description: Mobile-first auth app — MobileTopBar + content + MobileDashboardDock bottom nav. Trigger when user runs /rresource:mobile-dock or asks to scaffold "mobile-dock" template into the current project.
---

# rresource:mobile-dock

**Kind:** layout
**Bundled spec:** `cookbook/layouts/mobile-dock.md`
...
2. **Read bundled spec.** Open `cookbook/layouts/mobile-dock.md` (relative to plugin
