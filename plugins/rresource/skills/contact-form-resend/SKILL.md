---
description: Contact form + Resend email pipeline w/ rate limit + spam check. Trigger when user runs /rresource:contact-form-resend or asks to scaffold "contact-form-resend" template into the current project.
---

# rresource:contact-form-resend

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/contact-form-resend.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/contact-form-resend.md` (relative to plugin
