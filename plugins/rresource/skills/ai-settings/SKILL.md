---
description: User-level AI provider config + quota dashboard (M). Adds /dashboard/ai-settings. Trigger when user runs /rresource:ai-settings or asks to scaffold "ai-settings" template into the current project.
---

# rresource:ai-settings

**Kind:** feature
**Bundled spec:** `cookbook/features/ai-settings.md`
...
2. **Read bundled spec.** Open `cookbook/features/ai-settings.md` (relative to plugin
