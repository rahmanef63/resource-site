---
description: Role-gated /admin route (S). Adds /admin route guarded by user.role==='admin'. Trigger when user runs /rresource:admin or asks to scaffold "admin" template into the current project.
---

# rresource:admin

**Kind:** feature
**Bundled spec:** `cookbook/features/admin.md`
...
2. **Read bundled spec.** Open `cookbook/features/admin.md` (relative to plugin
