---
description: Three-column dashboard (left tree / main / right inspector). Resizable, collapsible, mobile drawer fallback. Trigger when user runs /rresource:3column or asks to scaffold "3column" template into the current project.
---

# rresource:3column

**Kind:** layout
**Bundled spec:** `cookbook/layouts/3column.md`
...
2. **Read bundled spec.** Open `cookbook/layouts/3column.md` (relative to plugin
