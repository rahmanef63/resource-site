---
description: Global AI side-panel (XL). Chat console + slash commands + OpenAI tool-calling + cross-slice action bus + ApproveActionCard for mutations. Trigger when user runs /rresource:ai-agent or asks to scaffold "ai-agent" template into the current project.
---

# rresource:ai-agent

**Kind:** feature
**Bundled spec:** `cookbook/features/ai-agent.md`
...
2. **Read bundled spec.** Open `cookbook/features/ai-agent.md` (relative to plugin
