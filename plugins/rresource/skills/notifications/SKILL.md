---
description: In-app notification center (M). Adds /dashboard/notifications. Trigger when user runs /rresource:notifications or asks to scaffold "notifications" template into the current project.
---

# rresource:notifications

**Kind:** feature
**Bundled spec:** `cookbook/features/notifications.md`
...
2. **Read bundled spec.** Open `cookbook/features/notifications.md` (relative to plugin
