---
description: Public marketing landing + Demo CTA (S). Adds / route. Trigger when user runs /rresource:hero or asks to scaffold "hero" template into the current project.
---

# rresource:hero

**Kind:** feature
**Bundled spec:** `cookbook/features/hero.md`
...
2. **Read bundled spec.** Open `cookbook/features/hero.md` (relative to plugin
