---
description: Threaded comments anchored to blocks/pages w/ resolve flow. Trigger when user runs /rresource:comments-threaded or asks to scaffold "comments-threaded" template into the current project.
---

# rresource:comments-threaded

**Kind:** recipe
**Bundled spec:** `cookbook/recipes/comments-threaded.md`
...
2. **Read bundled spec.** Open `cookbook/recipes/comments-threaded.md` (relative to plugin
