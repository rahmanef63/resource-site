---
description: 36 OKLCH theme presets + mode toggle + PWA chrome sync (L infra). Trigger when user runs /rresource:theme-preset or asks to scaffold "theme-preset" template into the current project.
---

# rresource:theme-preset

**Kind:** feature
**Bundled spec:** `cookbook/features/theme-preset.md`
...
2. **Read bundled spec.** Open `cookbook/features/theme-preset.md` (relative to plugin
