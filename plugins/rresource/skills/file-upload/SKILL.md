---
description: Convex storage + WebP convert + Canvas crop + tenant-scoped access (XL infra). Provides useFileUpload + <FileUpload> + files table. Trigger when user runs /rresource:file-upload or asks to scaffold "file-upload" template into the current project.
---

# rresource:file-upload

**Kind:** feature
**Bundled spec:** `cookbook/features/file-upload.md`
...
2. **Read bundled spec.** Open `cookbook/features/file-upload.md` (relative to plugin
