---
description: Super-admin analytics + AI gateway + skill catalog + audit log + feedback inbox + roadmap editor (L). Adds /dashboard/admin-panel. Trigger when user runs /rresource:admin-panel or asks to scaffold "admin-panel" template into the current project.
---

# rresource:admin-panel

**Kind:** feature
**Bundled spec:** `cookbook/features/admin-panel.md`
...
2. **Read bundled spec.** Open `cookbook/features/admin-panel.md` (relative to plugin
