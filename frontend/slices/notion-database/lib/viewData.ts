...
/** Date-shaped values carry `{ date: "YYYY-MM-DD" }` (notion-database
 *  DateCell encoding). Returns midnight-anchored Date or null. */
...
function matchesFilter(
  ...
  // Empty / not_empty are universal — short-circuit ahead of type dispatch.
  ...
  // Text fallback (covers text / url / email / phone / unknown).
