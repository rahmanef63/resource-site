...
/** Small presentational helpers extracted from `PageEditorView` to keep
 *  each file under the 200-LOC cap. No business logic. */
    ...
    <div className="space-y-3">
      ...
      <div className="rounded-lg border border-amber-500/40 bg-amber-500/5 p-4 text-sm">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          This page is rendered from source, not the block editor. To customize, duplicate
