...
export default function ExecTerminal() {
  ...
  // Mode can flip at runtime (configureTerminal) while the terminal is open —
  ...
  return (
    <div
      ...
      className="h-full w-full overflow-y-auto bg-[#0d0e12] p-3.5 [padding-bottom:calc(0.875rem+var(--sai-bottom,0px))] font-mono text-[12.5px] leading-relaxed text-[#dfe3ea] [font-family:var(--font-mono-ui,monospace)] select-text"
    >
