...
Helper functions with no dependencies on UI or business logic.
...
Utilities for transforming and handling data.
Re-exports from the original folders for backward compatibility.
...
Feature-based modules with UI components and pages.
Re-exports from the original folders for backward compatibility.
...
Global UI elements (not business features).
