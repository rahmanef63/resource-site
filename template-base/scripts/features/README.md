...
**Note:** Semua scripts menggunakan feature registry system yang auto-discover features dari `frontend/slices/*/config.ts`. Bundle configuration juga 100% dynamic - features declare their own bundle membership!
