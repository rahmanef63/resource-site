...
import { ArrowRight, Briefcase, Inbox, Sparkles, Users, type LucideIcon } from "lucide-react";
...
function Stat({ icon: Icon, label, v, href }: { icon: LucideIcon; label: string; v: number; href: string }) {
  return (
