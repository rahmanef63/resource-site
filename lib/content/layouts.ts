...
export const layouts: LayoutEntry[] = [
  {
    ...
    demoUrl: "https://personal-brand-os-ten.vercel.app",
    adminPreviewPath: "/preview/personal-brand-os/dashboard/admin",
...
export default function HomePage() {
  ...
  },
  {
    ...
    demoUrl: "https://agency-studio-os.vercel.app",
    adminPreviewPath: "/preview/agency-studio-os/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
...
export default function Layout({ children }) {
  ...
  },
  {
    ...
    previewPath: "/preview/notion-page-clone-os/public",
    demoUrl: "https://silong-os.vercel.app",
    adminPreviewPath: "/preview/notion-page-clone-os/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
...
export default function Page() { return <Dashboard activeKind="doc" activeId="doc-welcome" />; }`,
  ...
  },
  {
    ...
    demoUrl: "https://saas-marketing-os-omega.vercel.app",
    adminPreviewPath: "/preview/saas-marketing-os/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
    ...
    files: [
      ...
      // Admin surface (BE-wave catalog fix — admin already exists on disk;
      // earlier metadata claimed "no admin" by mistake).
...
export default function Page() { return <HomePage />; }`,
  ...
  },
  {
    ...
    demoUrl: "https://kreator-studio-os.vercel.app",
    adminPreviewPath: "/preview/kreator-studio-os/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
...
export default function Page() { return <HomePage />; }`,
  ...
  },
  {
    ...
    demoUrl: "https://konsultan-os.vercel.app",
    adminPreviewPath: "/preview/konsultan-os/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
...
export default function Page() { return <HomePage />; }`,
  ...
  },
  {
    ...
    demoUrl: "https://wirausaha-os.vercel.app",
    adminPreviewPath: "/preview/wirausaha-os/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
...
export default function Page() { return <HomePage />; }`,
  ...
  },
  {
    ...
    demoUrl: "https://riset-kit.vercel.app",
    adminPreviewPath: "/preview/riset-kit/dashboard/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
