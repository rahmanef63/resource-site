...
export default function Layout({ children }) {
  ...
  },
  {
    ...
    adminPreviewPath: "/preview/notion-page-clone-os/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.9,
    pullPaths: [
    ...
    files: [
      ...
      "app/preview/notion-page-clone-os/admin/layout.tsx",
      "app/preview/notion-page-clone-os/admin/admin-shell-client.tsx",
      "app/preview/notion-page-clone-os/admin/page.tsx",
      "app/preview/notion-page-clone-os/admin/snippets/page.tsx",
