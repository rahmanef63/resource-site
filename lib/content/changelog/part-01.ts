    ...
    "groups": [
      {
        ...
        "bullets": [
          ...
          "Public listAll remains index-ordered and bounded to 500 rows, get remains a public marketing-content read, admin create/update/remove stay server-gated by requireAdmin(ctx), and seed remains internal-only."
        ]
      }
    ]
  },
