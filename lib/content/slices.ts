...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    env: [],
    peers: [
      { slug: "notion-shell", range: "^0.5", reason: "Domain types (Database, Property, PropertyValue, DbView, RollupAggregate, etc.) live in notion-shell. v0.5 extends Property with relation + rollup fields." },
    ],
