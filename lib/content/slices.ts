...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    kind: "ui",
    version: "0.1.0",
    tagline: "One install ships 4 Notion-style primitives: equation + code + notify + drag-fill.",
    ...
    tags: ["ui", "notion", "block", "primitive", "bundle", "editor", "katex", "highlight", "subscription", "drag-fill", "notion-like"],
  ...
  {
    slug: "theme-presets",
    title: "Theme Presets — tweakcn loader + 30+ color schemes",
    category: "ui",
    kind: "ui",
    version: "0.1.0",
  ...
  },
  {
    ...
    tags: ["ui", "notion", "notion-like", "database", "table", "board", "list", "gallery", "calendar", "feed", "kanban", "views", "filter", "sort", "property", "primitive", "optional", "embeddable"],
    usedBy: ["notion-page-clone-os"],
