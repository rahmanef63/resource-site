...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    title: "Notion-like Database Table — full table with import/export + row peek (11 views · 16 cells · CSV + JSON)",
    category: "ui",
    kind: "ui",
    version: "0.7.0",
    tagline: "Full Notion-style database table: 11 views, 16 interactive cells, CSV + JSON import/export with dynamic templates, and a slot-driven row peek (sheet + dialog + persisted toggle). Single drop-in slice — no companion peer install needed.",
