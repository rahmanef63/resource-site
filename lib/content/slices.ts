...
// Any tab on the same origin sees the change instantly.`,
  ...
  },
  {
    ...
    kind: "full",
    version: "0.3.0",
    tagline: "Access-gated admin in 2 variants — a minimal generic shell, or the composed 26-section console that mounts your other slices. Each pulls only its own backend.",
    ...
    variants: [
      { title: "shell", desc: "npx rr add admin shell — minimal generic admin shell (AdminPage + buildAdminStats), convex/features/admin only." },
      { title: "console", desc: "npx rr add admin console — composed 26-section AdminConsole mounting other slices, convex/features/admin_console only." },
    ],
    tags: ["infra", "admin", "console", "shell", "dashboard", "composition", "rbac", "access-gate", "registry"],
    usedBy: [],
