...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    kind: "ui",
    version: "0.6.0",
    tagline: "Full Notion-style database table: 11 views, 16 interactive cells, CSV + JSON import/export with dynamic templates. Single drop-in slice — no companion peer install needed.",
    ...
    npm: ["recharts@^2.13.0"],
    shadcn: ["button", "input", "checkbox", "dropdown-menu", "popover", "select", "dialog"],
    env: [],
    peers: [
