...
// Any tab on the same origin sees the change instantly.`,
  ...
  },
  {
    ...
    version: "0.22.0",
    maturity: "beta",
    tagline: "Portable Notion-style PAGE editor: blocks + slash menu + inline toolbar + colour + layout + built-in code/equation. Pair with notion-sidebar + notion-database.",
