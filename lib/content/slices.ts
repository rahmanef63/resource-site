...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    docsUrl: "",
    install: "",
    slicePath: "frontend/slices/workspace-shell",
    convexPaths: ["convex/features/workspaceShell"],
    npm: [],
