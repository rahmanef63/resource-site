...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    slicePath: "template-base/frontend/slices/admin",
    convexPaths: ["template-base/convex/features/admin"],
    npm: [],
  ...
  },
  {
    ...
    slicePath: "template-base/frontend/slices/admin/slices/events",
    convexPaths: ["template-base/convex/features/admin", "template-base/convex/features/analytics"],
    npm: [],
    shadcn: [],
    env: [],
