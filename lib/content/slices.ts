...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    title: "Notion-like Database Table — full table with import/export + row peek + relation/rollup + row multi-select w/ checkboxes + calendar drag helpers (11 views · 18 cells · CSV + JSON)",
    category: "ui",
    kind: "ui",
    version: "0.11.0",
    maturity: "beta",
    ...
    env: [],
    peers: [
      { slug: "notion-shell", range: "^0.6", reason: "Domain types live in notion-shell. v0.6 extends Property with numberCurrencyCode + dateFormat + timeFormat + dateIncludeTime; DatabaseViewConfig moved to ./view-config-types.ts for the 200-LOC cap." },
    ],
