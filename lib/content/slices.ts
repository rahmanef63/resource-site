...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    title: "Notion Database — embedded DB surface (10 views, optional)",
    category: "ui",
    kind: "ui",
    version: "0.2.0",
    tagline: "Notion-style embedded database: 10 views (Table/Board/List/Gallery/Calendar/Feed/Chart/Dashboard/Map/Timeline) + filter + sort + 10 property cells. Optional companion to notion-shell.",
    description: "Portable Notion-style database surface. Optional companion to notion-shell — install shell alone for pages + sidebar + block editor, add notion-database when you want embedded databases. Ships NotionDatabase (full DB UI w/ ViewTabs + ViewOptions + per-column menu + FilterBuilder/SortBuilder popovers), NotionProperty (value + schema editor), 10 property-cell types (text / number / checkbox / select / multi_select / status / date / url / email / phone), 10 built-in views: Table / Board / List / Gallery / Calendar / Feed PLUS Chart (recharts bar/line/area/pie/donut + inline kind/X/agg/Y pickers) / Dashboard (KPI strip + group breakdowns + recent updates) / Map (SVG world + lat/lng pins, no leaflet) / Timeline (Gantt-style with drag-to-shift / drag-to-resize). FilterBuilder + SortBuilder exported standalone for toolbar embedding. Pure helpers: applyView, groupBy, bucketByDate. Domain types live in notion-shell (single source of truth — Page.rowOfDatabaseId + rowProps reference them) and re-exported here for convenience. Lifted from notion-page-clone (Nosion) — CI-wave split (2026-05-21), CK-wave view + builder completion (2026-05-21).",
    source: "notion-page-clone",
    ...
    tags: ["ui", "notion", "notion-like", "database", "table", "board", "list", "gallery", "calendar", "feed", "chart", "dashboard", "map", "timeline", "gantt", "kanban", "views", "filter", "sort", "property", "primitive", "optional", "embeddable"],
    usedBy: ["notion-page-clone-os"],
