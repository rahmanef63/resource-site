...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    title: "Notion-like Database Table — full table with import/export + row peek + relation/rollup (11 views · 18 cells · CSV + JSON)",
    category: "ui",
    kind: "ui",
    version: "0.8.0",
    tagline: "Full Notion-style database table: 11 views, 18 interactive cells (now incl. relation + rollup), CSV + JSON import/export with dynamic templates, and a slot-driven row peek (sheet + dialog + persisted toggle). Single drop-in slice — no companion peer install needed.",
    ...
    npm: ["recharts@^2.13.0"],
    shadcn: ["button", "input", "checkbox", "dropdown-menu", "popover", "select", "dialog", "sheet", "toggle-group", "tooltip"],
    env: [],
    peers: [
