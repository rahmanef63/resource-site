...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    env: [],
    peers: [],
    tags: ["ui", "notion", "shell", "wrapper", "sidebar", "page", "database", "primitive", "portable"],
    usedBy: ["notion-page-clone-os"],
    agentRecipe: "Run `npx rr add notion-shell`. Zero peer deps. Import wrappers + types: `import { NotionPage, NotionSidebar, NotionBlock, NotionDatabase, type Block, type Database, type Page } from \"@/features/notion-shell\"`. Pure props — host owns the data + emits change callbacks. NotionBlock dispatches via `blockRenderers` prop (pair with notion-blocks for equation/code/notify/grid). For rich icon UX wire `renderIcon` + `renderIconPicker` props to `@/features/icon-picker`.",
