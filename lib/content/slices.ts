...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    convexPaths: [],
    npm: ["lucide-react@^0.400.0", "next@^15", "react@^18"],
    shadcn: [],
    env: [],
    peers: [],
  ...
  },
  {
    ...
    version: "0.2.0",
    maturity: "deprecated",
    tagline: "⚠️ Deprecated — merged into notion-database v0.6 (Phase 7.10). Install `notion-database` instead.",
