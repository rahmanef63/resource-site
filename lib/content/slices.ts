...
export default convexAuthNextjsMiddleware();`,
  ...
  },
  {
    ...
    kind: "ui",
    version: "0.1.0",
    description: "KaTeX-rendered LaTeX equation block. Display mode by default; click pencil to edit raw LaTeX. Zero convex tables — pure UI primitive. Lifted 2026-05-19 from notion-page-clone via rr-sync pipeline.",
    source: "notion-page-clone",
    ...
    env: [],
    peers: [],
    tags: ["ui", "math", "latex", "katex", "block", "primitive", "notion"],
    usedBy: [],
    agentRecipe: "Run `npx rr add equation`. <EquationBlock text onText registerRef /> — display + edit mode toggles via pencil. KaTeX rendering on each text change.",
  ...
  },
  {
    ...
    kind: "ui",
    version: "0.1.0",
    description: "Per-page subscription state stored client-side in localStorage. NotifyMePopover surfaces a bell trigger that toggles scope checkboxes (page / comments / edits / thread). No server backend required — pure-UI primitive. Lifted 2026-05-19 from notion-page-clone via rr-sync.",
    source: "notion-page-clone",
    ...
    env: [],
    peers: [],
    tags: ["ui", "notifications", "subscription", "localstorage", "popover", "notion"],
    usedBy: [],
    agentRecipe: "Run `npx rr add notifications`. <NotifyMePopover pageId trigger? /> renders a bell button that opens scope picker. State auto-persists per pageId via useSubscription hook.",
  ...
  },
  {
    ...
    kind: "ui",
    version: "0.1.0",
    description: "highlight.js-powered code block with language selector + copy-to-clipboard. Streaming-friendly edit mode. Drop-in primitive for any editor or doc layout. Lifted 2026-05-19 from notion-page-clone via rr-sync.",
    source: "notion-page-clone",
    ...
    env: [],
    peers: [],
    tags: ["ui", "code", "syntax-highlight", "highlightjs", "block", "primitive", "notion"],
    usedBy: [],
    agentRecipe: "Run `npx rr add code-block`. <CodeBlock text lang onText onLang registerRef onKeyDown /> — supports all highlight.js common languages via normalizeLang. github-dark theme bundled.",
  ...
  },
  {
    ...
    kind: "ui",
    version: "0.1.0",
    description: "Drag-fill behavior + selectable-cell primitive for grid/database UIs. useDragFill hook tracks source cell + drag target row; SelectableCell wraps each cell with selection state, fill-handle, and visual feedback. Pure UI — host controls data + rowIds. Lifted 2026-05-19 from notion-page-clone via rr-sync.",
    source: "notion-page-clone",
    ...
    env: [],
    peers: [],
    tags: ["ui", "database", "grid", "drag-fill", "selection", "primitive", "notion"],
    usedBy: [],
    agentRecipe: "Run `npx rr add database-cell-selection`. useDragFill({ rowIds, onFill }) returns { source, start, isInFillRange, isFilling }. SelectableCell wraps each cell with rowId/propId props + selected/inFillRange/showFillHandle visual flags.",
