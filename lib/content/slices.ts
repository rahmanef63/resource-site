...
export default convexAuthNextjsMiddleware();`,
  ...
  // ─────────────────────────────────────────────────────────────
  // AI slices — every consumer-facing archetype has a public + admin
  // preview pair, then ai-admin (operator) and ai-router (backend) sit
  // underneath as shared infrastructure.
  //
  // Tag taxonomy (refactored 2026-05-16):
  //   "ai"            — umbrella (every entry)
  //   "ai:<arch>"     — archetype: chatbot|first-app|copilot|agent|search|admin|backend
  //   capability tags — multimodal, streaming, tool-calls, rag, agent-mode,
  //                     voice, image-gen, citations, branching, history
  // ─────────────────────────────────────────────────────────────
  {
    slug: "ai-router",
    ...
    compat: {
      templates: {
        "personal-brand-os": { status: "recommended", note: "Every AI surface (chatbot, copilot, search) composes on top." },
        "kreator-studio-os": { status: "recommended" },
        "saas-marketing-os": { status: "warn", note: "Marketing site has no AI surface by default." },
      },
      enhances: ["ai-chatbot", "ai-first-app", "ai-copilot", "ai-agent-runner", "ai-search", "ai-admin"],
    },
  },
  {
    slug: "ai-chatbot",
    ...
    convexPaths: ["convex/features/ai-chatbot"],
    npm: ["ai@^4.0.0", "@ai-sdk/anthropic@^0.0.50", "@ai-sdk/openai@^0.0.60"],
    shadcn: ["button", "card", "badge", "avatar", "scroll-area", "select", "separator", "slider", "switch", "textarea", "tabs"],
    env: [
    ...
    peers: [
      ...
      { slug: "ai-admin", range: "^0.1", reason: "Reads skills/tools/models from ai-admin registry." },
      { slug: "vector-search", range: "^0.1", reason: "Optional — RAG tool uses workspace embeddings." },
    ],
    tags: ["ai", "ai:chatbot", "streaming", "multimodal", "tool-calls", "agent-mode", "rag", "citations", "branching", "history"],
    usedBy: [],
    ...
    previewPath: "/preview/slices/ai-chatbot",
    adminPreviewPath: "/preview/slices/ai-chatbot/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.55,
    compat: {
      templates: {
        "personal-brand-os": { status: "recommended", note: "Bolts onto admin panel as a customer-support workbench." },
        "kreator-studio-os": { status: "recommended", note: "Default content-ideation surface." },
        "saas-marketing-os": { status: "warn", note: "Marketing pages — only useful if you wire it to support." },
      },
  ...
  },
  {
    ...
    convexPaths: ["convex/features/ai-first-app"],
    npm: ["ai@^4.0.0"],
    ...
    peers: [
      ...
      { slug: "ai-admin", range: "^0.1", reason: "Templates + moderation rules live in ai-admin." },
    ],
    tags: ["ai", "ai:first-app", "generation", "streaming", "history", "branching", "image-gen"],
    usedBy: [],
    ...
    previewPath: "/preview/slices/ai-first-app",
    adminPreviewPath: "/preview/slices/ai-first-app/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.6,
    compat: {
  ...
  },
  {
    ...
    convexPaths: ["convex/features/ai-copilot"],
    npm: ["ai@^4.0.0"],
    shadcn: ["button", "card", "badge", "command", "scroll-area", "sheet", "separator", "tooltip"],
    env: [],
    peers: [
      { slug: "convex-auth", range: "^0.1", reason: "Suggestions scoped to authed user." },
      { slug: "ai-router", range: "^0.1", reason: "Inference via tiered router." },
      { slug: "ai-admin", range: "^0.1", reason: "Trigger rules + personas live in ai-admin." },
    ],
    tags: ["ai", "ai:copilot", "streaming", "tool-calls", "suggestions", "context-aware"],
    usedBy: [],
    ...
    previewPath: "/preview/slices/ai-copilot",
    adminPreviewPath: "/preview/slices/ai-copilot/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.6,
    compat: {
      templates: {
        "personal-brand-os": { status: "recommended", note: "Posts editor + comments admin both benefit." },
      },
      enhances: ["ai-router", "ai-admin"],
    },
  },
  {
    ...
    convexPaths: ["convex/features/ai-agent-runner"],
    npm: ["ai@^4.0.0"],
    ...
    peers: [
      ...
      { slug: "ai-admin", range: "^0.1", reason: "Agents defined in ai-admin.agents." },
      { slug: "audit-log", range: "^0.1", reason: "Every step logged." },
    ],
    tags: ["ai", "ai:agent", "agent-mode", "tool-calls", "async", "queue", "traces"],
    usedBy: [],
    ...
    previewPath: "/preview/slices/ai-agent-runner",
    adminPreviewPath: "/preview/slices/ai-agent-runner/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.6,
    compat: {
  ...
  },
  {
    ...
    convexPaths: ["convex/features/ai-search"],
    npm: ["ai@^4.0.0"],
    shadcn: ["button", "card", "badge", "input", "tabs", "scroll-area", "separator"],
    env: [],
    peers: [
      { slug: "convex-auth", range: "^0.1", reason: "Per-workspace corpus scoping." },
      { slug: "ai-router", range: "^0.1", reason: "Answer synthesis via router." },
      { slug: "ai-admin", range: "^0.1", reason: "Reranker + source weights tunable in ai-admin." },
      { slug: "vector-search", range: "^0.1", reason: "Embeddings index for retrieval." },
    ],
    tags: ["ai", "ai:search", "rag", "citations", "streaming", "corpus"],
    usedBy: [],
    ...
    previewPath: "/preview/slices/ai-search",
    adminPreviewPath: "/preview/slices/ai-search/admin",
    defaultSurface: "public",
    defaultView: "desktop",
    defaultZoom: 0.6,
    compat: {
      templates: {
        "personal-brand-os": { status: "recommended", note: "Knowledge base reader for blog + docs." },
      },
      enhances: ["ai-router", "ai-admin", "vector-search"],
    },
  },
  {
    ...
    npm: [],
    shadcn: ["card", "button", "badge", "tabs", "table", "dialog", "input", "label", "select", "textarea", "switch"],
    ...
    peers: [
      ...
      { slug: "rbac-roles", range: "^0.1", reason: "Section gated by AI_ADMIN permission." },
    ...
    tags: ["ai", "ai:admin", "config", "providers", "models", "skills", "tools", "agents", "budgets"],
    usedBy: [],
    ...
    compat: {
      ...
      enhances: ["ai-chatbot", "ai-first-app", "ai-copilot", "ai-agent-runner", "ai-search", "ai-router", "audit-log"],
    },
  },
  {
    slug: "vector-search",
