// @dod:skip-uiux013 reason="reports: state handling delegated to tree/list subcomponents"
﻿"use client"
            ...
            {savedReports?.map((report: any) => (
              <Card key={report._id}>
                ...
                <CardFooter className="flex justify-between">
                  <Button aria-label="Delete" variant="ghost" size="sm" onClick={() => handleDeleteReport(report._id)}>
