...
## Purpose
Inventory feature logic and capabilities.

## Entry Points
- config: `frontend/slices/inventory/config.ts`
- page: `frontend/slices/inventory/page.tsx`
- views: `frontend/slices/inventory/views/*`
- hooks: `frontend/slices/inventory/hooks/*`
- frontend agent: `frontend/slices/inventory/agent/index.ts`
- backend agent: `convex/features/inventory/agent.ts`
- settings: `frontend/slices/inventory/settings/*`
- init: `frontend/slices/inventory/init.ts`
