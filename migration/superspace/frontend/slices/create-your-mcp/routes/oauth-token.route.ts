...
// Non-functional scaffold: local convexHttp stub (throws until wired to a real
// ConvexHttpClient). See ../lib/convex-http.ts.
...
export async function POST(req: Request) {
  ...
  try {
    const result = (await convexHttp.mutation(
      "features/createYourMcp/mutation:exchangeCode",
      {
        code: body.code,
